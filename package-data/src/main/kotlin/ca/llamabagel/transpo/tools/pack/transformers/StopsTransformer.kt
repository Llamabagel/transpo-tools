...
object StopsTransformer : DataTransformer<Stop> {
    ...
    private fun assignParentStations(item: Stop): Stop {
        return when (item.code) {
            ParentStations.baseline.code -> item.copy(locationType = 0, parentStation = ParentStations.baseline.id.value)
            ParentStations.bayshore.code -> item.copy(locationType = 0, parentStation = ParentStations.bayshore.id.value)
            ParentStations.bayview.code -> item.copy(locationType = 0, parentStation = ParentStations.bayview.id.value)
            ParentStations.beatrice.code -> item.copy(locationType = 0, parentStation = ParentStations.beatrice.id.value)
            ParentStations.billingsBridge.code -> item.copy(locationType = 0, parentStation = ParentStations.billingsBridge.id.value)
            ParentStations.blair.code -> item.copy(locationType = 0, parentStation = ParentStations.blair.id.value)
            ParentStations.canadianTireCentre.code -> item.copy(locationType = 0, parentStation = ParentStations.canadianTireCentre.id.value)
            ParentStations.carleton.code -> item.copy(locationType = 0, parentStation = ParentStations.carleton.id.value)
            ParentStations.dominion.code -> item.copy(locationType = 0, parentStation = ParentStations.dominion.id.value)
            ParentStations.eaglesonEast.code -> item.copy(locationType = 0, parentStation = ParentStations.eaglesonEast.id.value)
            ParentStations.eaglesonWest.code -> item.copy(locationType = 0, parentStation = ParentStations.eaglesonWest.id.value)
            ParentStations.fallowfield.code -> item.copy(locationType = 0, parentStation = ParentStations.fallowfield.id.value)
            ParentStations.greenboro.code -> item.copy(locationType = 0, parentStation = ParentStations.greenboro.id.value)
            ParentStations.heron.code -> item.copy(locationType = 0, parentStation = ParentStations.heron.id.value)
            ParentStations.hurdman.code -> item.copy(locationType = 0, parentStation = ParentStations.hurdman.id.value)
            ParentStations.innovation.code -> item.copy(locationType = 0, parentStation = ParentStations.innovation.id.value)
            ParentStations.iris.code -> item.copy(locationType = 0, parentStation = ParentStations.iris.id.value)
            ParentStations.jeanneDarc.code -> item.copy(locationType = 0, parentStation = ParentStations.jeanneDarc.id.value)
            ParentStations.laurier.code -> item.copy(locationType = 0, parentStation = ParentStations.laurier.id.value)
            ParentStations.lebreton.code -> item.copy(locationType = 0, parentStation = ParentStations.lebreton.id.value)
            ParentStations.lees.code -> item.copy(locationType = 0, parentStation = ParentStations.lees.id.value)
            ParentStations.leitrim.code -> item.copy(locationType = 0, parentStation = ParentStations.leitrim.id.value)
            ParentStations.lincolnFields.code -> item.copy(locationType = 0, parentStation = ParentStations.lincolnFields.id.value)
            ParentStations.longfields.code -> item.copy(locationType = 0, parentStation = ParentStations.longfields.id.value)
            ParentStations.lyceeClaudel.code -> item.copy(locationType = 0, parentStation = ParentStations.lyceeClaudel.id.value)
            ParentStations.mackenzieKing.code -> item.copy(locationType = 0, parentStation = ParentStations.mackenzieKing.id.value)
            ParentStations.marketplace.code -> item.copy(locationType = 0, parentStation = ParentStations.marketplace.id.value)
            ParentStations.millennium.code -> item.copy(locationType = 0, parentStation = ParentStations.millennium.id.value)
            ParentStations.moodie.code -> item.copy(locationType = 0, parentStation = ParentStations.moodie.id.value)
            ParentStations.mooneysBay.code -> item.copy(locationType = 0, parentStation = ParentStations.mooneysBay.id.value)
            ParentStations.nepeanWoods.code -> item.copy(locationType = 0, parentStation = ParentStations.nepeanWoods.id.value)
            ParentStations.pinecrest.code -> item.copy(locationType = 0, parentStation = ParentStations.pinecrest.id.value)
            ParentStations.placeDOrleans.code -> item.copy(locationType = 0, parentStation = ParentStations.placeDOrleans.id.value)
            ParentStations.pleasantPark.code -> item.copy(locationType = 0, parentStation = ParentStations.pleasantPark.id.value)
            ParentStations.queensway.code -> item.copy(locationType = 0, parentStation = ParentStations.queensway.id.value)
            ParentStations.rideau.code -> item.copy(locationType = 0, parentStation = ParentStations.rideau.id.value)
            ParentStations.riverside.code -> item.copy(locationType = 0, parentStation = ParentStations.riverside.id.value)
            ParentStations.riverview.code -> item.copy(locationType = 0, parentStation = ParentStations.riverview.id.value)
            ParentStations.smyth.code -> item.copy(locationType = 0, parentStation = ParentStations.smyth.id.value)
            ParentStations.southKeys.code -> item.copy(locationType = 0, parentStation = ParentStations.southKeys.id.value)
            ParentStations.stLaurent.code -> item.copy(locationType = 0, parentStation = ParentStations.stLaurent.id.value)
            ParentStations.strandherd.code -> item.copy(locationType = 0, parentStation = ParentStations.strandherd.id.value)
            ParentStations.terryFox.code -> item.copy(locationType = 0, parentStation = ParentStations.terryFox.id.value)
            ParentStations.train.code -> item.copy(locationType = 0, parentStation = ParentStations.train.id.value)
            ParentStations.trim.code -> item.copy(locationType = 0, parentStation = ParentStations.trim.id.value)
            ParentStations.tunneysPasture.code -> item.copy(locationType = 0, parentStation = ParentStations.tunneysPasture.id.value)
            ParentStations.walkley.code -> item.copy(locationType = 0, parentStation = ParentStations.walkley.id.value)
            ParentStations.westboro.code -> item.copy(locationType = 0, parentStation = ParentStations.westboro.id.value)
            else -> item
        }
    }
